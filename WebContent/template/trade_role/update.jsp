...
<body>
<form action="/trade_role/updatepost.do" method="post">
	<table>
		<tr><td>id</td><td><input name="id" id="id" type="text" value="${vo.id }"/></td></tr>
		<tr><td>roleno</td><td><input name="roleno" id="roleno" type="text" value="${vo.roleno }"/></td></tr>
		<tr><td>roleName</td><td><input name="roleName" id="roleName" type="text" value="${vo.roleName }"/></td></tr>
