...
<table align="center" border="0">
	...
	<tr><td>角色编号:</td><td><input name="roleNo" type="text" size="60" maxlength="50" /></td></tr>
	<tr><td>角色名称:</td><td><input name="roleName" type="text" size="60" maxlength="50" /></td></tr>
	<tr><td>角色描述:</td><td><input name="description" type="text" size="60" maxlength="50" /></td></tr>
	<tr><td>排序:</td><td><input name="sort" type="text" size="60" maxlength="50" /></td></tr>
	<tr><td>是否有效，1=是，0=否:</td><td><input name="isVisible" type="text" size="60" maxlength="50" /></td></tr>
