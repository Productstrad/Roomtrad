...
<body>
<form action="/trade_rolepermission/updatepost.do" method="post">
	<table>
		...
		<tr><td>modulePermissionID</td><td><input name="modulePermissionID" id="modulePermissionID" type="text" value="${vo.modulePermissionID }"/></td></tr>
