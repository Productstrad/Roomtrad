...
public class TradeModulepermissionAction {
	...
	public String list(HttpServletRequest request,HttpServletResponse response			
			,Model model) {	
		Long modulePermissionID=ParamUtil.getLongParameter(request,"modulePermissionID"));Integer moduleID=ParamUtil.getIntegerParameter(request,"moduleID"));Integer permissionID=ParamUtil.getIntegerParameter(request,"permissionID"));Integer createUserID=ParamUtil.getIntegerParameter(request,"createUserID"));Date createDate=ParamUtil.getDateParameter(request,"createDate"));Integer modifyUserID=ParamUtil.getIntegerParameter(request,"modifyUserID"));Date modifyDate=ParamUtil.getDateParameter(request,"modifyDate"));String recordStatus=ParamUtil.getStringParameter(request,"recordStatus"));Integer isDeleted=ParamUtil.getIntegerParameter(request,"isDeleted"));
