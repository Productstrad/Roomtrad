...
public class TradeDepartmentDao {
	...
	private Logger logger = Logger.getLogger(TradeDepartmentDao.class);
	private String proxool_M="proxool.defaultDB";
	private String proxool_S="proxool.defaultDB_s0";	
	
	public int insert(TradeDepartment vo){
		int result = 0;		
		if( null == vo ){
			return -1;
		}		
	 ...
	 * @return	 
	 */
	public List<TradeDepartment> find(Map<String, Object> paramsMap,int pageNo,int pageSize){
	 ...
	 * @return	
	 */
	public TradeDepartment findByPK(Object id) {
	 ...
	 * @author mengdz	 
	 */
	public TradeDepartment findSingle(Map<String, Object> params) {
		List<TradeDepartment> list=find(params, 1, 1);
	 ...
	 * @return	 
	 */
	public int update(TradeDepartment vo) {
		int result = 0;		
		if( vo.getId()==null){
			return -1;
		}		
